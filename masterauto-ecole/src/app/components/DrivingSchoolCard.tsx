...
const DrivingSchoolCard = ({ school }: { school: DrivingSchool }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 md:p-6 flex flex-col h-full justify-between w-full min-h-[40rem]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full items-stretch">
        {/* Left Column */}
        <div className="lg:border-r lg:border-gray-100 flex flex-col h-full flex-1">
        ...
        {/* Right Column */}
        <div className="p-6 lg:shadow-sm lg:rounded-r-lg lg:bg-white/50 flex-1 flex flex-col h-full justify-between">
          <div className="flex-1 flex flex-col">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-gray-800 mb-2 truncate">{school.name}</h1>
          ...
          <div className="flex flex-row gap-2 mt-auto">
            <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">Voir les détails</button>
            <button className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors">S'inscrire</button>
          </div>
        </div>
      </div>
